...
#ifndef RTCPCLVoxelFilter_H
#define RTCPCLVoxelFilter_H
...
namespace RTCPCL
{
    ...
    struct process_impl
    {
        ...
        {
            std::cerr <<
                "RTCPCLVoxelFilter: Cloud does not have XYZ fields.\n";
            return false;
        }
    };
    ...
    struct process_impl<true>
    {
                ...
                typename pcl::PointCloud<PointT>::Ptr& output)
        {
            ...
            {
                std::cerr << "RTCPCLVoxelFilter: Input has wrong point type\n";
    ...
    class RTCPCLVoxelFilter
        : public RTCPCLBase
    {
        public:
            RTCPCLVoxelFilter(RTC::Manager* manager);
        ...
        private:
            ...
            boost::any voxel_filter_;

#define VOXELFILTER_APPLY(r, _, elem) \
                ...
                return process_impl< \
                    HasXYZ<BOOST_PP_TUPLE_ELEM(2, 1, elem)>::value>::do_it< \
                        BOOST_PP_TUPLE_ELEM(2, 1, elem)>( \
                            voxel_filter_, res_x_, res_y_, res_z_, input, \
                            output); \
            }
