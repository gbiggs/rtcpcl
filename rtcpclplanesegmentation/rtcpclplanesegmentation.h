...
#ifndef RTCPCLPLANESEGMENTATION_H_
#define RTCPCLPLANESEGMENTATION_H_
...
namespace RTCPCL
{
    class RTCPCLPlaneSegmentation
        : public RTC::DataFlowComponentBase
    {
        public:
            RTCPCLPlaneSegmentation(RTC::Manager* manager);
            virtual ~RTCPCLPlaneSegmentation();
        ...
        private:
            ...
            PointCloudTypes::PointCloud corba_inliers_;
            RTC::OutPort<PointCloudTypes::PointCloud> corba_inliers_port_;
            PointCloudTypes::PointCloud corba_outliers_;
            RTC::OutPort<PointCloudTypes::PointCloud> corba_outliers_port_;
#if defined(DDS_SUPPORT)
            RTC::DDSSubPort<PointCloudTypes_PointCloud,
                PointCloudTypes_PointCloudSeq,
                PointCloudTypes_PointCloudDataReader> dds_in_port_;
            PointCloudTypes_PointCloud* dds_inliers_;
            RTC::DDSPubPort<PointCloudTypes_PointCloud,
                PointCloudTypes_PointCloudDataWriter> dds_inliers_port_;
            PointCloudTypes_PointCloud* dds_outliers_;
            RTC::DDSPubPort<PointCloudTypes_PointCloud,
                PointCloudTypes_PointCloudDataWriter> dds_outliers_port_;
#endif // defined(DDS_SUPPORT)

            bool corba_;
            bool dds_;
            bool pointer_;
            double ndist_weight_;
            unsigned int max_iters_;
            double dist_thresh_;

            pcl::SACSegmentationFromNormals<pcl::PointXYZRGBNormal, pcl::PointXYZRGBNormal>
                segmenter_;

            void process(pcl::PointCloud<pcl::PointXYZRGBNormal>::Ptr in_cloud,
...
#endif // RTCPCLPLANESEGMENTATION_H_
