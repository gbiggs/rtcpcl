...
RTCPCLFPFH::RTCPCLFPFH(RTC::Manager* manager)
    : RTCPCLBase(manager),
...
RTC::ReturnCode_t RTCPCLFPFH::onInitialize()
{
...
RTC::ReturnCode_t RTCPCLFPFH::onActivated(RTC::UniqueId ec_id)
{
...
{
    "implementation_id", "RTCPCLFPFH",
    "type_name",         "RTCPCLFPFH",
    "description",       "Point cloud component for fast point feature histograms",
    "version",           "1.0",
...
extern "C"
{
    void rtc_init(RTC::Manager* manager)
    {
        ...
        manager->registerFactory(profile, RTC::Create<RTCPCLFPFH>,
                RTC::Delete<RTCPCLFPFH>);
    }
};
